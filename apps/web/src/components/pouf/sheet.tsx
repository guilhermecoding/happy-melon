...
export function Sheet({ trigger, title, description, children, open, onOpenChange }: SheetProps) {
  return (
    <RDialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      {/* Overlay and content are direct Portal children: Radix wraps each child
          in its own Presence, so a wrapper element would have to animate too or
          it unmounts instantly and swallows the slide-out. */}
      <RDialog.Portal>
