...
export default function LoginPage({
  ...
  return (
    <Page className="relative flex min-h-svh flex-col items-center justify-center overflow-hidden bg-muted p-6 md:p-10">
      <div
        aria-hidden
      ...
      <Section className="flex justify-center items-center mt-6">
        <span className="text-sm text-muted-foreground bg-white z-100 py-2 px-4 rounded-full border-3 border-muted-foreground flex flex-row items-center gap-1">
