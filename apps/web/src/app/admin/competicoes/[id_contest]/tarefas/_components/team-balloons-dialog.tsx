...
function PrintRequestCard({
  ...
  return (
    <div className="relative flex min-w-0 flex-col items-center justify-center rounded-2xl border border-border bg-background p-2">
      ...
      <span
        title="Impressão"
        className="mt-6 block w-full max-w-full truncate text-center font-space-grotesk text-2xl font-semibold text-foreground"
      >
        Impressão
      </span>
  ...
  return (
    <>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <HugeiconsIcon
                        icon={
                          canConfirm ? CheckmarkCircle02Icon : RemoveCircleIcon
                        }
                        className="size-5"
                        strokeWidth={3}
                      />
      ...
      <Confirm
        ...
        body={`Deseja realmente reter o balão de ${team?.name ?? 'este time'}? O balão retornará ao ponto de partida.`}
        confirmLabel="Reter"
